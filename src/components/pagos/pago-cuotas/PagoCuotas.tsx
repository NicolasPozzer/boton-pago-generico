...
import PaymentCuotasPage from "@/components/pagos/Servipag/pages/payment-cuotas";
...
export default function PagoCuotas() {
  ...
  const nroCuota = searchParams?.get("nroCuota") ?? "";
  const monto = searchParams?.get("monto") ?? "";
  const router = useRouter();

  const handleServipagPayment = () => {
    router.push(`/paymentData?nroCuota=${nroCuota}&monto=${monto}`);
  };
  ...
  return (
    <>
    <div className="min-h-screen bg-slate-50 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 rounded-t-full">
            ...
            <>
              <div className="bg-gray-50 p-4 rounded-lg">
                ...
                <div className="flex justify-between">
                  <span>Pago de Cuota nro. {nroCuota}</span>
                  <span>$ {monto}</span>
                </div>
              ...
              <Accordion type="single" collapsible>
                <AccordionItem value="item-1">
                  ...
                  <AccordionContent>
                    Ofrecemos un reembolso completo dentro de los primeros 30 días de la compra si no estás satisfecho con el curso.
                  </AccordionContent>
                </AccordionItem>
              </Accordion>
            </>
        ...
        {step === 1 && (
          <div className="p-6 pt-0">
            <div className="w-full space-y-4">
              ...
              <PaymentCuotasPage nroCuota={nroCuota} monto={monto} />
            </div>
          </div>
        )}
      </Card>
